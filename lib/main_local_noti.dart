...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _showBigPictureNotification() async {
    final String largeIconPath = await _downloadAndSaveFile(
        'https://via.placeholder.com/48x48', 'launch_background');
    final String bigPicturePath = await _downloadAndSaveFile(
        'https://via.placeholder.com/400x800', 'launch_background');
  ...
  Future<void> _showNotificationMediaStyle() async {
    final String largeIconPath = await _downloadAndSaveFile(
        'https://via.placeholder.com/128x128/00FF00/000000', 'launch_background');
    final AndroidNotificationDetails androidPlatformChannelSpecifics =
    AndroidNotificationDetails(
      'media channel id',
      'media channel name',
  ...
  Future<void> _showMessagingNotification() async {
    ...
    const Person me = Person(
      ...
      key: '1',
      uri: 'tel:1234567890',
      icon: DrawableResourceAndroidIcon('launch_background'),
    );
    const Person coworker = Person(
      name: 'Coworker',
      key: '2',
      uri: 'tel:9876543210',
      icon: FlutterBitmapAssetAndroidIcon('launch_background'),
    );
